...
class Card:
    ...
    def __eq__(self, other):
        """Compares this card to another card. Returns true if they are the same card. Must be the same suit."""
    ...
    def get_hard_value(self):
        """Returns the numerical value of the card. All Aces return 1."""
        if self.card_face == 'A':
            return 1
        ...
        if self.card_face == 'C':
            raise ValueError('Cannot determine value of cut card')
